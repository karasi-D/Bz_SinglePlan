...
bool operator==(const ::sdf_tools::CollisionMap_<ContainerAllocator1> & lhs, const ::sdf_tools::CollisionMap_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.origin_transform == rhs.origin_transform &&
    lhs.dimensions == rhs.dimensions &&
    lhs.cell_size == rhs.cell_size &&
    lhs.OOB_occupancy_value == rhs.OOB_occupancy_value &&
    lhs.OOB_component_value == rhs.OOB_component_value &&
    lhs.number_of_components == rhs.number_of_components &&
    lhs.components_valid == rhs.components_valid &&
