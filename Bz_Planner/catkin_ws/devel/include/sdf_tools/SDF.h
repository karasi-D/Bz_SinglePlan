...
bool operator==(const ::sdf_tools::SDF_<ContainerAllocator1> & lhs, const ::sdf_tools::SDF_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.origin_transform == rhs.origin_transform &&
    lhs.dimensions == rhs.dimensions &&
    lhs.sdf_cell_size == rhs.sdf_cell_size &&
    lhs.OOB_value == rhs.OOB_value &&
