...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /home/karasi/my_code/Bz_Planner/catkin_ws/src/uav_simulator/map_server/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /home/karasi/my_code/Bz_Planner/catkin_ws/devel)
  ...
  set(local_sensing_node_INSTALL_PREFIX /home/karasi/my_code/Bz_Planner/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/karasi/my_code/Bz_Planner/catkin_ws/src/uav_simulator/map_server/local_sensing/${idir}'.  ${_report}")
    endif()
